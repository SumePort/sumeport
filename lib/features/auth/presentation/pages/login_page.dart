              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SumePortText('Welcome back', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w700), textAlign: TextAlign.center),
                    const SizedBox(height: 8),
                    SumePortText('Continue building your career with SumePort.', style: TextStyle(fontSize: 15, color: Theme.of(context).colorScheme.onSurfaceVariant), textAlign: TextAlign.center),
                    const SizedBox(height: 32),
                    SumePortTextField(
                      controller: _emailController,
                      label: 'Email', hint: 'you@example.com', prefixIcon: Icons.email_outlined,
                      keyboardType: TextInputType.emailAddress, textInputAction: TextInputAction.next, enabled: !isLoading,
                      validator: (value) {
                    ...
                    SumePortTextField(
                      ...
                      label: 'Password', hint: 'Enter your password', prefixIcon: Icons.lock_outline,
                      obscureText: _obscurePassword, enabled: !isLoading, textInputAction: TextInputAction.done,
                      onSubmitted: (_) => _login(),
                      suffixIcon: _obscurePassword ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                      onSuffixTap: isLoading ? null : () => setState(() => _obscurePassword = !_obscurePassword),
                      validator: (value) => value == null || value.isEmpty ? 'Please enter your password.' : null,
                    ),
                    const SizedBox(height: 12),
                    Align(alignment: Alignment.centerRight, child: TextButton(onPressed: isLoading ? null : () => _showMessage('Password reset will be available soon.'), child: const Text('Forgot password?'))),
                    const SizedBox(height: 12),
                    SumePortButton(label: isLoading ? 'Signing in...' : 'Sign in', onPressed: isLoading ? null : _login, isLoading: isLoading, isFullWidth: true),
                    const SizedBox(height: 24),
